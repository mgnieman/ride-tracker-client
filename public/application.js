...
var config = {
  apiOrigins: {
    ...
    production: 'https://ridetrackermn.herokuapp.com'
  }
};
...
var showRidesTemplate = __webpack_require__(18);
var store = __webpack_require__(3);

var clearRides = function clearRides() {
  $('.content').empty();
  // $('.clear').hide()
  // $('.get').show()
};

var addNewRide = function addNewRide() {
  $('.get').hide();
  $('.content').hide();
...
var addRideSuccess = function addRideSuccess(data) {
...
var getRidesSuccess = function getRidesSuccess(data) {
  clearRides();
  var showRidesHtml = showRidesTemplate({ rides: data.rides });
...
var deleteRideSuccess = function deleteRideSuccess(index) {
...
var editRideSuccess = function editRideSuccess(event) {
  $('.update').show();
  // prefill Date, Distance, Duration
  var tr = $(event.target).parent().parent();

  var date = tr.find('td.ride-date').text();
  var dateField = $('#update-ride').find('input[name="ride[date]"]');
  dateField.attr('value', date);

  var distance = tr.find('td.ride-distance').text();
  var distanceField = $('#update-ride').find('input[name="ride[distance]"]');
  distanceField.attr('value', distance);

  var duration = tr.find('td.ride-duration').text();
  var durationField = $('#update-ride').find('input[name="ride[duration]"]');
  durationField.attr('value', duration);

  var id = $(event.target).attr('data-id');
  var idField = $('#update-ride').find('input[name="ride[id]"]');
  idField.attr('value', id);
};

var updateRideSuccess = function updateRideSuccess() {
  // $('#clearRidesButton').click()
  clearRides();
  //
  $('#getRidesButton').click();
...
module.exports = {
  ...
  addRideSuccess: addRideSuccess,
  getRidesSuccess: getRidesSuccess,
  clearRides: clearRides,
  deleteRideSuccess: deleteRideSuccess,
  editRideSuccess: editRideSuccess,
  updateRideSuccess: updateRideSuccess,
  failure: failure
};
...
var rideEvents = __webpack_require__(36);
...
var ridesUi = __webpack_require__(7);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n      <!-- "
    ...
    + "</td>\n        <td class = \"ride-distance\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.distance : stack1), depth0))
    + "</td>\n        <td class = \"ride-duration\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.duration : stack1), depth0))
    + "</td>\n        <td>\n          <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"deleteRideButton btn btn-danger\">Delete Ride</button>\n          <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"editRideButton btn btn-info\">Edit Ride</button>\n        <td>\n      </tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<table class=\"table\">\n  <thead>\n    <tr>\n      <th>Date</th>\n      <th>Distance</th>\n      <th>Duration</th>\n      <th>Actions</th>\n    </tr>\n  </thead>\n  <tbody>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.rides : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</tbody>\n<table>\n";
...
var onAddNewRide = function onAddNewRide(event) {
  event.preventDefault();
  ui.addNewRide();
};
var onAddRide = function onAddRide(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.addRide(data).then(ui.addRideSuccess).catch(ui.failure);
};
var onGetRides = function onGetRides(event) {
  event.preventDefault();
  api.getRides().then(function (data) {
...
//   ui.clearRides()
// }
var onDeleteRide = function onDeleteRide(event) {
  event.preventDefault();
  var index = $(event.target).attr('data-id');
  api.deleteRide(index).then(function () {
    ui.deleteRideSuccess(index);
  }).catch(ui.failure);
};
var onEditRide = function onEditRide() {
...
var onUpdateRide = function onUpdateRide(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateRide(data).then(ui.updateRideSuccess).catch(ui.failure);
};
var addHandlers = function addHandlers() {
...
var addRide = function addRide(data) {
  return $.ajax({
...
var deleteRide = function deleteRide(data) {
  return $.ajax({
...
var updateRide = function updateRide(data) {
  return $.ajax({
